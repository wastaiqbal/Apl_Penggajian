...
Public Class Form3
    Sub TampilGrid()
        Call koneksi()
        da = New OdbcDataAdapter("select nip, nama, jenis_kelamin, alamat, no_rek,jabatan,tgl_masuk, gaji_pokok, uang_lembur, potongan, gaji_total, tgl_transfer From tb_pegawai", conn)
        ds = New DataSet
        ds.Clear()
